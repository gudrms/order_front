...
export default function StorePage() {
    ...
    const handleFindNearby = () => {
        // The hook handles fetching on mount, but if we want to re-trigger or manual trigger, 
        // we might need to adjust the hook or just rely on the initial fetch.
        // For now, since the hook fetches on mount, this button might be redundant or 
        // we can make the hook lazy. 
        // However, to keep it simple and match previous behavior (button click),
        // let's assume the user wants to see their location *if* it's already loaded.
        if (loaded && coordinates) {
            setMapCenter(coordinates);
            // Re-sort logic is already in useEffect, but we can center map here.
        } else if (!loaded) {
