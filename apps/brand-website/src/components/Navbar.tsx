            ...
            <div className="container mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link 
                        ...
                        target="_blank"
                        className="hidden md:flex items-center gap-2 bg-brand-yellow text-brand-black px-5 py-2.5 rounded-full font-bold hover:bg-white hover:text-brand-green transition-all transform hover:-translate-y-0.5 shadow-lg shadow-brand-yellow/20"
                    >
                        <Phone size={18} />
                        <span>주문하기</span>
                    </Link>
