...
- [x] `src/lib/` - 유틸리티 폴더 생성 (api/, utils/, constants/)
- [x] `src/stores/` - Zustand 스토어 폴더 생성
...
- ✅ PWA 섹션 추가
- ✅ 프론트엔드 체크리스트 작성
- ✅ 폴더 구조 생성 (components, features, hooks, lib, stores, types)
- ✅ 환경 변수 설정 (.env, .env.development, .env.production)
